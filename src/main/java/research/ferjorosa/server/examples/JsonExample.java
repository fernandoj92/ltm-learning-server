...
import research.ferjorosa.server.export.fileFormat.ConvertBN;
...
public class JsonExample {
    ...
    private static void syntheticExample(){
        //We can open the data stream using the static class DataStreamLoader
        DataStream<DataInstance> data = DataStreamLoader.open("data/syntheticData.arff");
        ...
        System.out.println(ConvertBN.toMyJson(bn,true));
    }
